// Faixa exibida em toda tela do modo de demonstração pública, avisando que nada
// digitado ali é gravado no banco de verdade. Renderizada dentro do cabeçalho
// "sticky" montado em AppShell.tsx, logo abaixo do Topbar.
