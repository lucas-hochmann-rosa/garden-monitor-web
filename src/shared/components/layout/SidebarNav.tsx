  ...
  return (
    <aside className="w-64 h-screen bg-white border-r border-[#dee2e6] flex flex-col fixed left-0 top-0">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg mb-1 transition-colors ${
                isActive ? 'bg-[#f1f5f0] text-[#324b2c]' : 'text-[#6c757d] hover:bg-[#f8f9fa]'
              }`}
            >
      ...
      <div className="px-3 pb-4 border-t border-[#dee2e6] pt-3">
        <button
          onClick={onSignOut}
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-red-500 hover:bg-red-50 transition-colors group"
        >
