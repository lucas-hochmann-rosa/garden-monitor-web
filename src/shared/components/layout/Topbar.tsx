...
// Barra superior: título da página atual, sino de alertas e um selo indicando se a
// sessão é o admin de verdade ou a demonstração pública (nunca mostra "ADMIN" dentro
// do modo de demonstração, para não sugerir que aquele acesso é privilegiado). Fica
// dentro do wrapper "sticky" montado em AppShell.tsx, não é fixa por conta própria.
